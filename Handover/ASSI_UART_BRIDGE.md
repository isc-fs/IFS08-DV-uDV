...
---
*Verified against `dev` @ `8af44e0` (2026-07-07): `Core/Src/ws2812.c`,
`Core/Inc/ws2812.h`, `Core/Src/assi_task.c`, `Core/Inc/assi_task.h`,
`Core/Src/app_task.cpp`, `Core/Src/usart.c`.*
