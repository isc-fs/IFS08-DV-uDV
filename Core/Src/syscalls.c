...
/* --- micro-ROS required stubs (rclc executor uses usleep & gettimeofday) --- */

/* HAL_Delay / HAL_GetTick declared in stm32h7xx_hal.h, but this file is
   autogenerated and doesn't include project headers.  Use extern decls. */
...
int _gettimeofday(struct timeval *tv, void *tz)
{
  ...
  if (tv)
  {
    ...
    tv->tv_sec  = (time_t)(tick / 1000u);
    tv->tv_usec = (suseconds_t)((tick % 1000u) * 1000u);
  }
  return 0;
}
